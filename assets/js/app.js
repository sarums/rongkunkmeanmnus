...
window.doSearch=(q2)=>{
  ...
  if(!q)return;
  NP.start();
  if(mobileMenuOpen){ mobileMenuOpen=false; const s=$("mobile-menu"),b=$("sheet-backdrop"); if(s)s.style.transform='translateY(100%)'; if(b){b.style.background='rgba(0,0,0,0)';setTimeout(()=>b.style.display='none',350);} }
